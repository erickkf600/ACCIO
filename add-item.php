...
<html lang="pt-br">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
        ...
        <input type=text" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor" name="nomeprod">
      </div>
    <div class="form-group col-md-3">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor" name="preco">
      </div>
