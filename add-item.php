...
<html lang="pt-br">
  ...
  <form method="post" action="add.php">
    ...
    <div class="form-group col-md-4">
        ...
        <input required type="number" min="0" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
      </div>
    <div class="form-group col-md-4">
        <label for="exampleInputEmail1">Categoria</label>
        <input required type="text" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
      </div>
  </div>
