...
<div class="form-group">
  ...
  <input type="numnber" min="0" class="form-control">
</div>
<div class="form-row">
  <div class="form-group col-md-6">
     ...
     <tbody>
      <tr>
        <td>
         ...
         <span>PLACA MÃE MSI Z170A GAMING M5, DDR4 CHIPSET Z170, LGA 1151</span>
     </td>
     <td>1</td>
     <td class="font-weight-bold">R$: 750,00</td>
 </tr>
</tbody>
</table>
<div class="card-footer">Frete Estimado: <span class="float-right font-weight-bold">R$ 25,00</span></div>
</div>
<h1 class="text-danger">Total: R$ 775,00</h1>
</div>
</div>
